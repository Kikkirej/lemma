...
public class TypeFocusedMappingModelJavaBaseGeneratorTemplate extends JavaBaseGeneratorTemplate {
  private static class TypeFocusedMappingModelTemplateCompletionDialog extends JavaBaseGeneratorTemplate.TemplateCompletionDialog {
    ...
    public Control createDialogArea(final Composite parent) {
      ...
      Point _point = new Point(AbstractCodeGeneratorCompletionDialog.DEFAULT_WIDTH, 630);
